...
export const Login = () => {
  ...
  return (
    ...
    >
      <h1 className="text-gray-800 text-center text-lg">Авторизация</h1>
      ...
      <div className="flex gap-8">
        ...
        <Link
          to={'/register'}
          className="flex justify-center items-center text-slate-500 py-1 my-3 px-3 mx-10 rounded-sm hover:text-black"
        >
          Регистрация
        </Link>
      </div>
